...
class FacturaFuente {
    ...
    crear(factura){
        ...
        return new Promise((resolve, reject) => {
            ...
            conection.query('INSERT INTO facturas (ProdCompr, PrecioTotal, FechaC, HoraC, DomicilioF, Proveedor, SerialPr, CI_Admin) VALUES (' +prodcompr+ ', ' +preciototal+ ', ' +fechac+ ', ' +horac+ ', ' +domicilio+ ', ' +proveedor+ ', ' +serialpr+ ', ' +cideladmin+ ')',
    ...
    ActualizarF(factura,idF){
        ...
        return new Promise((resolve, reject) => {
            ...
            conection.query('UPDATE facturas SET ProdCompr = '+prodcompr+', PrecioTotal = '+preciototal+', FechaC = '+fechac+', HoraC = '+horac+', DomicilioF = '+domicilio+', Proveedor = '+proveedor+', SerialPr = '+serialpr+' WHERE ID = '+idF,
            function (error, results, fields){
                if(error) throw error;
